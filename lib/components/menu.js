export class Menu extends HTMLElement {
    ...
    build() {
        ...
        menu.innerHTML = `
            <menu>
                <li>
                    <a class="importacao-dados" href="/pages/importacaoDados">Importação de dados</a>
                </li>
                <li>
                    <a class="analise-descritiva" href="/pages/analiseDescritiva">Análise Descritiva</a>
                </li>
                <li>
                    <a class="analise-exploratoria-dados" href="/pages/analiseExploratoriaDados">Análise exploratória de dados (AED)</a>
                </li>
            </menu>
        `
